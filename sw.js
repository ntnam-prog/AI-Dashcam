const CACHE='distanceadas-v1.1-beta.6r2-landscape-labelfix-1';
const APP=['./','./index.html','./style.css?v=116r2ls1','./app.js?v=116r2ls1','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
