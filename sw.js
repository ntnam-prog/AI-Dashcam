const CACHE='distanceadas-v1.1-beta.6r2-wide-tele-1';
const APP=['./','./index.html','./style.css?v=116r2wt','./app.js?v=116r2wt','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
