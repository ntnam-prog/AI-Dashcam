const CACHE='distanceadas-v1.1-beta.6r2-da80-ai-1';
const APP=['./','./index.html','./style.css?v=116r2da80ai','./app.js?v=116r2da80ai','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
