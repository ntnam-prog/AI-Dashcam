const CACHE='distanceadas-v1.1-beta.6r2-displayfix-1';
const APP=['./','./index.html','./style.css?v=116r2df1','./app.js?v=116r2df1','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
